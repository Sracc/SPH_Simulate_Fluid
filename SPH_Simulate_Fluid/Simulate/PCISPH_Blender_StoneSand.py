...
from SPH_Simulate_Fluid.SPH_Physics.PCISPH_Physics import PCISPHPhysics
...
use_cache = False
save_cache = True
save_cache_filename = "1. PCISPH.pkl"
cache_path = r"/Applications/Blender.app/Contents/Resources/2.83/python/lib/python3.7/site-packages/SPH_Simulate_Fluid/PCISPH_Cache"

save_ply_file = False
ply_nick_name = "SPH_CUBE_SEPARATED"

ply_export_path = r"/Applications/Blender.app/Contents/Resources/2.83/python/lib/python3.7/site-packages/SPH_Simulate_Fluid/PCISPH_Ply"


total_simulate_frames = 100
...
if use_cache is True:
    ...
    ps.add_cube(lower_corner=[1,2, 5.5],
                    cube_size=[2, 2, 2.0],
                    material=ps.fluid_particle,
                    )
